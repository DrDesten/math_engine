...
export function matchNumber( num, maxResults = 5 ) {
...
export function processNumber( x, maxResults = 5, maxError = 0.5 ) {
    // Get All Results, apply the corresponding weighing fuctions
...
export function processNumberMinimal( x, maxResults = 1, maxError = 0.01 ) {
    // Get All Results, apply the corresponding weighing fuctions
...
export function printNumbers( solArr = [new Solution()] ) {
...
export function searchConstants( str = "", maxResults = 5 ) {
    let results = []
